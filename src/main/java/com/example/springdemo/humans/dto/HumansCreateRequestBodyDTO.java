...
public record HumansCreateRequestBodyDTO(String name, String surname, Integer age, String gender) {
    public static void validate(HumansCreateRequestBodyDTO body) {
        if(body.name() == null){
